 ...
 * singleton, but without handling the object construction itself.
 * In other words, it's a glorified global variable that points to the
...
public:
  inline static C* current() { return static_cast<C*>(s_current); }
};
